import { useConfig, RoutesTableConfigProvider } from 'app/context/config';
import { usePageQuery } from 'app/context/pagination';
import { useFiltersQuery } from 'app/context/filters';
import { useSearchQuery, RoutesSearchProvider } from 'app/context/search';
import { RouteDetailsProvider, useRoutesLoading } from 'app/context/routes';
import { RoutesFiltersProvider } from 'app/context/filters';
import PageHeader from 'app/components/page/Header';
import SearchGlobalInput from 'app/components/search/SearchGlobalInput';
import SearchStatus from '../components/search/SearchStatus';
import WaitingCard from 'app/components/spinners/WaitingCard';
import FiltersEditor from 'app/components/filters/FiltersEditor';
...
const SearchGlobalContent = () => {
  ...
  return (
    <div className="lookup-container">
      ...
      <div className="page-body page-body-columns">
        <div className="my-container" style={{ flexGrow: 1 }}>
          <SearchGlobalInput />
          {hasQuery && <Routes />}
        </div>

        {hasQuery && <div className="my-container">
          <SearchStatus />
